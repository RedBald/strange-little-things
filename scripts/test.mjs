...
const checks = [
  ...
  [html.includes("aria-hidden=\"true\">🍄"), "mushroom brand mark"],
  [html.includes("Lisa has always loved the simple, creative parts of life."), "expanded About Lisa story"],
  [css.includes("Palatino Linotype"), "readable decorative heading type"]
];
